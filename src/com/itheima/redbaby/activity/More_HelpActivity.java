...
public class More_HelpActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 获取数据 -- 帮助列表
		GetDataByNet.getDataByNet(this, "help",
				BaseParamsMapUtil.getHelp("12"), new HelpParser(),
				new GetDataByNet.OnSetDataListener() {
					@Override
					public void setData(Object data) {
						...
						// 得到第一级数据后再请求 第二级数据(因为工具类中的一些静态字段会被之后的调用覆盖)
	...
	private void getData_2() {
		// 获取数据 -- 帮助内容
		GetDataByNet.getDataByNet(More_HelpActivity.this, "help_detail",
				BaseParamsMapUtil.getHelp_Detail("1"),
				new Help_ContentParser(), new GetDataByNet.OnSetDataListener() {
					@Override
					public void setData(Object data) {
						...
						listView.setOnItemClickListener(new OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> parent,
								...
								Intent intent = new Intent(
										More_HelpActivity.this,
										HelpContentActivity.class);
								intent.putExtra("title",
										help_details.get(position).getTitle());
								intent.putExtra("content",
										help_details.get(position).getContent());
	...
	private class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			View view = View.inflate(More_HelpActivity.this,
					R.layout.more_item, null);
			((TextView) view.findViewById(R.id.moreitem_textContent))
					.setText(helps.get(position).getTitle());
			return view;
		}
